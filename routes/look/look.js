...
// 引入数据库表结构模型
const cartoonImgModel = require("../../models/look/cartoonImgModel"); // 漫画章节列表
...
// http://localhost:5000/public/imgs/001.jpg
let o = {
    title: '序章 硝烟域泪',
    imgList: [
        {
...
let Chapter = new cartoonImgModel(o)
